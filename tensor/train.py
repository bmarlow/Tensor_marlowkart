...
if __name__ == '__main__':
    # Load Training Data
    x_train = np.load("/root/tensor/data/X.npy", allow_pickle=True)
    y_train = np.load("/root/tensor/data/y.npy", allow_pickle=True)
    ...
    model.save_weights('/root/tensor/results/model_weights.h5')
